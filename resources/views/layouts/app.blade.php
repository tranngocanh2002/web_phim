...
<head>
  <title>
    Admin web rapphim360
  </title>
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Admin web rapphim360" />
  <!-- CSRF Token -->
  ...
  <div class="main-content">
      ...
      <aside class="sidebar-left">
        <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1>
              <a class="navbar-brand" href="{{url('/home')}}"><span class="fa fa-area-chart"></span> Admin<span
                  class="dashboard_text">Dashboard</span></a>
            </h1>
          </div>
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview {{($segment == 'category') ? 'active' : ''}}">
                ...
                <ul class="treeview-menu">
                  <li>
                    <a href="{{route('category.index')}}"><i class="fa fa-angle-right"></i> Liệt kê danh mục phim</a>
                  </li>
                  <li>
              ...
              <li class="treeview {{($segment == 'movie' || $segment == 'leech-detail' ||  $segment == 'leech-movie' ||  $segment == 'leech-episode') ? 'active' : ''}}">
                <a href="">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="{{route('leech-movie')}}"><i class="fa fa-angle-right"></i> Leech phim</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="treeview {{($segment == 'linkmovie') ? 'active' : ''}}">
                ...
                <ul class="treeview-menu">
                  <li>
                    <a href="{{route('linkmovie.index')}}"><i class="fa fa-angle-right"></i> Liệt kê link</a>
                  </li>
                  <li>
                    <a href="{{route('linkmovie.create')}}"><i class="fa fa-angle-right"></i> Thêm link</a>
                  </li>
                </ul>
              </li>
    ...
    <div class="sticky-header header-section">
      ...
      <div class="header-right">
        ...
        <!--//end-search-box-->
        <div class="search-box">
          Online: {{\Tracker::onlineUsers()->count()}}
        </div>
      ...
      <div class="main-page">
        <div class="col_3">
          ...
          <div class="col-md-3 widget">
            <div class="r3_counter_box">
              <i class="pull-left fa fa-video-camera dollar2 icon-rounded"></i>
              <div class="stats">
                <h5><strong>$.</strong></h5>
                <span>Tập phim</span>
              </div>
    ...
    $('.category_select').change(function(){
            ...
            $('.status_select').change(function(){
                ...
                $.ajax({
                    ...
                    method:"GET",
                    data:{status_id:status_id, movie_id:movie_id},
                    success:function(data) {
                        // $('#show_movie').html(data);
            ...
            $('.type_select').change(function(){
                ...
                $.ajax({
                    ...
                    method:"GET",
                    data:{type_id:type_id, movie_id:movie_id},
                    success:function(data) {
                        // $('#show_movie').html(data);
                        alert('Đổi [Thuộc phim] thành công');
                    }
                });
            })
            $('.phim_hot_select').change(function(){
                var phim_hot_id = $(this).val();
                var movie_id = $(this).attr('id');
                // alert(movie_id);
                $.ajax({
                    url:"{{route('phim_hot-select')}}",
                    method:"GET",
                    data:{phim_hot_id:phim_hot_id, movie_id:movie_id},
                    success:function(data) {
                        // $('#show_movie').html(data);
                        alert('Đổi [Phim hot] thành công');
                    }
                });
            })
            $('.resolution_select').change(function(){
                ...
                $.ajax({
                    ...
                    method:"GET",
                    data:{resolution_id:resolution_id, movie_id:movie_id},
                    success:function(data) {
                        // $('#show_movie').html(data);
                        alert('Đổi [Định dạng] thành công');
                    }
                });
            })
            $('.sub_select').change(function(){
                ...
                $.ajax({
                    ...
                    method:"GET",
                    data:{sub_id:sub_id, movie_id:movie_id},
                    success:function(data) {
                        // $('#show_movie').html(data);
                        alert('Đổi [Phụ đề] thành công');
                    }
                });
            })
  </script>
  ...
  <script>
    function myFunction(button) {
      ...
      if (copyText.value) {
        ...
        alert("Không có giá trị để sao chép");
      }
    }
    </script>
  {{-- <script type="text/javascript">
